jQuery.extend({
			...
			if (browser == "Microsoft Internet Explorer"
				...
				return io;
					...
					&& (trim_Version == "MSIE8.0"
							|| trim_Version == "MSIE7.0" || trim_Version == "MSIE6.0")) {
				var io = document.createElement('iframe');
				io.id = frameId;
				io.name = frameId;
	...
	/*
	 * createUploadIframe: function(id, uri) { //create frame var
	 * frameId = 'jUploadFrame' + id; var iframeHtml = '<iframe id="' +
	 * frameId + '" name="' + frameId + '" style="position:absolute;
	 * top:-9999px; left:-9999px"'; if(window.ActiveXObject) { if(typeof
	 * uri== 'boolean'){ iframeHtml += ' src="' + 'javascript:false' +
	 * '"';
