...
function initsitAcceptInfo(){
	...
	query.click(function(){
		...
		table.bootstrapTable('refresh',{
			url:dev_construction+'SitAccept/queryListSitAccept.asp?call='+tableCall+'&SID='+SID+'&'+param});
	});
	...
	table.bootstrapTable({
		//请求后台的URL（*）
		url : dev_construction+'SitAccept/queryListSitAccept.asp?call='+tableCall+'&SID='+SID,
		method : 'get', //请求方式（*）   
	...
	edit.click(function(){
		var seles = $('#sitAccept_Table').bootstrapTable("getSelections");
		if(seles.length!=1){
			alert("请选择一条数据进行受理!");
			return;
		}
		...
		openInnerPageTab("edit_Sit","sit测试受理","dev_construction/sit_test_jn/sitaccept/sitAccept_edit.html", function(){
	...
	view.bind('click', function(e) {
		...
		openInnerPageTab("view_Sit","查看sit测试受理","dev_construction/sit_test_jn/sitaccept/sitAccept_queryInfo.html", function(){
