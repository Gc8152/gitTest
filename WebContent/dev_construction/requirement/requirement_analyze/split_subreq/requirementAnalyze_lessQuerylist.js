//@ sourceURL=requirementAnalyze_lessQuerylist.js
	...
	// 查询
	 currTab.find("#serach_reqQuery").click(function() {
		...
		table.bootstrapTable('refresh',{
			url:dev_construction+"requirement_splitreq/queryReqForLessAnalyzeList.asp?SID="+SID+
			"&call="+subQueryListCall+"&"+param});
	});
...
function initSplitReqQueryTable() {
		...
		table.bootstrapTable("destroy").bootstrapTable({
					url :dev_construction+"requirement_splitreq/queryReqForLessAnalyzeList.asp?SID="+SID+"&call="+subQueryListCall,
					method : 'get', // 请求方式（*）
