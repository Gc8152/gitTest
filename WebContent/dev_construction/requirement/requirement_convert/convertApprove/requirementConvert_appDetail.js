function initConvertApprove(CONVERT_NO){
	var currTab = getCurrentPageObj();
	var call = getMillisecond()+'1';
    baseAjaxJsonp(dev_construction+"ReqConvert/queryReqConvertApproveList.asp?SID="+SID+"&call="+call+"&CONVERT_NO="+CONVERT_NO,null, function(data){
...
function initConvertTask(CONVERT_NO){
	...
	currTab.find("#ConvertAppDetailTable").bootstrapTable({
		//需求点00为初始为了表头
