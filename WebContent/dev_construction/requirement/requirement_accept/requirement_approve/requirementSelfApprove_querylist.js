...
function initReqApproveQueryBtn() {
	...
	getCurrentPageObj().find("#serach_reqAprQuery").click(function() {
		...
		table.bootstrapTable('refresh',{
			url:dev_construction+"requirement_accept/queryReqForSelfApprovetList.asp?SID="+SID+
...
function initReqAprListQueryTable() {
		...
		table.bootstrapTable("destroy").bootstrapTable({
					url :dev_construction+"requirement_accept/queryReqForSelfApprovetList.asp?SID="+SID+"&call="+reqAprQueryListCall+"&menu=01",
					method : 'get', // 请求方式（*）
