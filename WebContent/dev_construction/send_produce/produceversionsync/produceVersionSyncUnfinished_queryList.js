...
function initVersionSyncList(){
	...
	//查询按钮
	 $page.find("#querySync").click(function(){
		 ...
		 syncTable.bootstrapTable('refresh',{
				url:dev_construction+"versionSync/queryVersionSyncUnfinishedList.asp?SID=" + SID + "&call=" + syncCall +'&'+param + "&ROLE=" + role});
	...
	function initSyncTable() {
		...
		syncTable.bootstrapTable({
					url :dev_construction+"versionSync/queryVersionSyncUnfinishedList.asp?SID=" + SID + "&call=" + syncCall + "&ROLE=" + role,
					method : 'get', // 请求方式（*）
