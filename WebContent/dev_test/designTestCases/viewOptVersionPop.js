function proManPop(obj,callparams,aaa){
	...
	obj.load("dev_test/testTaskHandOver/arrangeTestManPop.html",{},function(){
		...
		modObj.find("[tb='testManPopTable']").bootstrapTable("destroy").bootstrapTable({
					url : dev_test+"designateDefect/queryProjectMan.asp?SID="+SID+"&call="+manCall,
					method : 'get', // 请求方式（*）
		...
		modObj.find("#manSearch").click(function(){
			...
			modObj.find("[tb='testManPopTable']").bootstrapTable('refresh',{url:dev_test+"designateDefect/queryProjectMan.asp?SID="+SID+"&call="+manCall+"&"+param});
		});
