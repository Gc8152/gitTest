function proManPop1(obj,callparams,SYSTEM_ID,DISCOVER_SYSTEM_ID){
	$("#defect_designate_modal").remove();
	//加载pop框内容
	obj.load("dev_test/defectManagement/designate/designateManPop.html",{},function(){
		...
		modObj.find("[tb='projectManPopTable']").bootstrapTable("destroy").bootstrapTable({
					url : dev_test+"designateDefect/queryProjectMan.asp?SID="+SID+"&call="+manCall+"&SYSTEM_ID="+SYSTEM_ID+"&DISCOVER_SYSTEM_ID="+DISCOVER_SYSTEM_ID,
					method : 'get', // 请求方式（*）
		...
		modObj.find("#manSearch").click(function(){
			...
			modObj.find("[tb='projectManPopTable']").bootstrapTable('refresh',{url:dev_test+"designateDefect/queryProjectMan.asp?SID="+SID+"&call="+manCall+"&"+param+"&SYSTEM_ID="+SYSTEM_ID+"&DISCOVER_SYSTEM_ID="+DISCOVER_SYSTEM_ID,});
		});
