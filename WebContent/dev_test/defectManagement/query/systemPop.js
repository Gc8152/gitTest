...
function getSystemPopUrl() {
	...
	var url = dev_test+'addDefect/queryApplication.asp?SID='+SID+'&query=query';
...
function openSystemPop(id,callparams){
	...
	getCurrentPageObj().find("#"+id).load("dev_test/defectManagement/query/systemPop.html",{},function(){
		getCurrentPageObj().find("#myModal_system").modal("show");
		initSystemPop("#pop_systemTable", getSystemPopUrl(), callparams);
