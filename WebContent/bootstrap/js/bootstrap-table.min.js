...
!function(a) {
    ...
    o.prototype.initServer = function(b, c) {
        ...
        d = a.extend({}, k(null , this.options.ajaxOptions), {
            ...
            jsonpCallback: this.options.jsonpCallback,	//动态生成回调方法
            success: function(a) {
    ...
    o.prototype.fitHeader = function() {
        ...
        this.$tableHeader.css({
            "margin-right": c
        }).find("table").html("").attr("class", this.$el.attr("class")).append(this.$header_),
        this.$header.find("th").each(function(b) {
...
/**
 * 由于bootstrap-table组件被重复加载而bootstrap-table-Edit.js组件却未被重复加载导致 edit组件不可用。
 * @param jq
 */
(function(jq){
	getCurrentPageObj().append('<script id="bootstrap-table_edit" src="js/commons/bootstrap-table-Edit.js"></script>');
	getCurrentPageObj().append('<script id="bootstrap-table-recall-selected" src="js/commons/bootstrap-table-recall-selected.js"></script>');
})(jQuery);