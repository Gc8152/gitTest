;function initNoconfighandleInfoLayout(param){
	var currTab = getCurrentPageObj();
	var form = currTab.find("#noconfigManageHandle_QueryInfo");
	var table = currTab.find("#noconfigManageHandleInfo_table");
	//currTab.find("input[name=CONFIG_ID]").val(config_id);
	//返回操作
	var back = currTab.find("#noconfigManageHandle_queryinfo_back");
