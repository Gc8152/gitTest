;function initNoconfigAcceptInfoLayout(param){
	var currTab = getCurrentPageObj();
	var form = currTab.find("#noconfigManageAccept_QueryInfo");
	var table = currTab.find("#noconfigManageAcceptInfo_table");
	//currTab.find("input[name=CONFIG_ID]").val(config_id);
	//返回操作
	var back = currTab.find("#noconfigManageAccept_queryinfo_back");
