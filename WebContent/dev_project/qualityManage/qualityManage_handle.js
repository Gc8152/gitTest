;function initQualityManageHandleLayout(quality_id){
	...
	submit.click(function(e){
		...
		baseAjaxJsonp(dev_project+"quality/handleQuality.asp?call="+call+"&SID="+SID+"&"+content, null, function(data){
	...
	function initLayout(){
		...
		initSelect(currTab.find("#h_status"),{value:"ITEM_CODE",text:"ITEM_NAME"},{dic_code:"P_DIC_QUALITY_STATUS"},null,null,arr);
		var call = getMillisecond();
