;function initQualityManageInfoLayout(quality_id){
	...
	function initLayout(){
		...
		baseAjaxJsonp(dev_project+"qualityManager/queryOneQuality.asp?call="+call+"&SID="+SID+"&QUALITY_ID="+quality_id, null, function(result){
			//项目项目基本信息
			for(var i in result){
