;function initproChangeInfo(){
	...
	query.click(function(){
		...
		table.bootstrapTable('refresh',{
			url:dev_project+'proChange/queryListApprove.asp?call='+tableCall+'&SID='+SID+'&type=2'+"&"+param});
	});
	...
	table.bootstrapTable({
		//请求后台的URL（*）
		url : dev_project+'proChange/queryListApprove.asp?call='+tableCall+'&SID='+SID+"&type=2",
		method : 'get', //请求方式（*）   
