;function initconfigManageValidateLayout(config_id){
	...
	submit.click(function(e){
		...
		baseAjaxJsonp(dev_project+"Confignotconform/confignotconformValidateUpdate.asp?call="+call+"&SID="+SID+"&"+content, null, function(data){
	...
	function initLayout(){
		...
		initSelect(currTab.find("#config_validate_status"),{value:"ITEM_CODE",text:"ITEM_NAME"},{dic_code:"P_DIC_QUALITY_STATUS"},null,null,arr);
