...
function initConfigAccept(){
	...
	currTab.find('#configAccept').click(function(){
		url = "dev_resourceManage/Configuration_database/Configuration_add.html";
		openInnerPageTab("configApply", "配置库申请",url, null);
	});
	...
	getCurrentPageObj().find('#configInfo').click(function(){
		...
		closeAndOpenInnerPageTab("config_info","查看配置信息","dev_resourceManage/Configuration_database/Configuration_queryInfo.html",function(){
...
function getConfigUrl(){
	var url = dev_resource+'ConfigApply/queryConfigApply.asp?call='+queryList_call+'&SID='+SID;
